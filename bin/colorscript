...
elif [[ -d "$HOME/.local/share/shell-color-scripts/colorscripts" ]]; then
    DIR_COLORSCRIPTS="$HOME/.local/share/shell-color-scripts/colorscripts"
elif [[ -d "/usr/local/share/shell-color-scripts/colorscripts" ]]; then
    DIR_COLORSCRIPTS="/usr/local/share/shell-color-scripts/colorscripts"
else
